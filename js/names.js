export const names = {
    mm:    i => ["auth", "open", "veto", "locked", "private", "password"][i+1], // because -1 = auth
    ...
    mod:   i => ["p1xbraten", "zeromod", "nooblounge", "remod", "suckerserv", "spaghetti", "wahnfred", "hopmod"][i+9], // because -9 = p1xbraten
}
